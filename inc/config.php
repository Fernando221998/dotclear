...
// Database user
define('DC_DBUSER','myferfd234e');

// Database password
define('DC_DBPASSWORD','0xvvgtnO');

// Database name
define('DC_DBNAME','dotclear188k');
...
define('DC_MASTER_KEY','6f8018950c4f39f640329b5e91178355');

// Admin URL. You need to set it for some features.
define('DC_ADMIN_URL','http://fernando.es.mialias.net/dotclear/admin/');

// Admin mail from address. For password recovery and such.
define('DC_ADMIN_MAILFROM','cornejo.hernandez.fernando@iescamas.es');
